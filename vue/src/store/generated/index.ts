...
import NameserviceNelNameservicenelNameservice from './nameservice-nel/nameservicenel.nameservice'
...
export default { 
  ...
  NameserviceNelNameservicenelNameservice: load(NameserviceNelNameservicenelNameservice, 'nameservicenel.nameservice'),
