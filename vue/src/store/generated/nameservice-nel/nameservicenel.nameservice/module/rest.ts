...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/nameservice-nel/nameservice/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<NameserviceQueryParamsResponse, RpcStatus>({
      path: `/nameservice-nel/nameservice/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/nameservice-nel/nameservice/whois
   */
  queryWhoisAll = (
    query?: {
    ...
    this.request<NameserviceQueryAllWhoisResponse, RpcStatus>({
      path: `/nameservice-nel/nameservice/whois`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
